...
public abstract class DataboxBlockLootTableProvider extends BlockLootSubProvider {

	protected DataboxBlockLootTableProvider() {
	...
	public void nuggetOre(Supplier<? extends Block> block, Item drop) {
		this.add(block.get(),
				(ore) -> createSilkTouchDispatchTable(ore,
						applyExplosionDecay(ore,
